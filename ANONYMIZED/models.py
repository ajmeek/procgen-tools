...
# NOTE: scale varies between ANONYMIZED and master branch, since we use both
...
def load_policy(model_file: str, action_size: int, device = None) -> CategoricalPolicy:
    ...
    # CURSED. scale varies between models trained on the ANONYMIZED vs. master branch.
    global scale
